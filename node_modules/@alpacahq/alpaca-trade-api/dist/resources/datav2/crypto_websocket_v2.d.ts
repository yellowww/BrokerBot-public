import { CryptoBar, CryptoQuote, CryptoTrade, RawCryptoTrade, RawCryptoQuote, RawCryptoBar } from "./entityv2";
...
export declare class AlpacaCryptoClient extends Websocket {
    ...
    dataHandler(data: Array<RawCryptoTrade | RawCryptoQuote | RawCryptoBar>): void;
}
export {};
