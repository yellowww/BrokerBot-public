...
function getDataV2(endpoint, path, options, config) {
    return __asyncGenerator(this, arguments, function* getDataV2_1() {
        ...
        while (true) {
            ...
            const params = Object.assign(Object.assign({}, options), { limit: limit, page_token: pageToken });
            const resp = yield __await(dataV2HttpRequest(path, params, config));
